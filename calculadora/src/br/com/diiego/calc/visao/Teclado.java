...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		c.weightx = 1;//determina o peso do botao
		c.weighty = 1;
		
		
		//Linha 1
		c.gridwidth = 2;//determina a largura do botão 
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0);
		c.gridwidth = 1;//tem que redimensionar os proximos botoes para voltarem a ocupar 1 espaco 
	...
	private void adicionarBotao(String texto, Color cor, GridBagConstraints c, int x, int y) {
		...
		botao.addActionListener(this); //escuta o evento do botão
		add(botao, c);
	}
	@Override
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() instanceof JButton) {
			JButton botao = (JButton) e.getSource();//imprime o texto do botão 
