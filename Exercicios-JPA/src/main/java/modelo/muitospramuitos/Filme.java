...
public class Filme {
	...
	@ManyToMany(cascade = CascadeType.PERSIST)//o persist adiciona os filmes que os atores estão incluidos
	...
	public List<Ator> getAtores() {
		if(atores == null) {//previne de não criar uma lista null e sim vazia.
