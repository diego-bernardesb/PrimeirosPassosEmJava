...
public class Outros {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nTakeWhile...");//pegue elemento enquanto obedecer uma condição
		alunos.stream()
		.distinct()
		.skip(2)
		.takeWhile(a -> a.nota >= 7) //enquanto nota >= 7 imprima o aluno, e para quando o proximo elemento não atende a condição
		.forEach(System.out::println);
